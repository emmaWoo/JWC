...
import com.ichg.joinworker.fragment.DialogFragment;
...
//		} else if (errorCode == APIBase.ErrorCode.UNKNOWN_SERVER_ERROR) {
//			setMessage(R.string.unknown_server_error).showAlertDialog();
//		} else if (errorCode == APIBase.ErrorCode.TIMEOUT_ERROR) {
//			setMessage(R.string.timeout_error).showAlertDialog();
//		} else if (errorCode == APIBase.ErrorCode.INVALID_API_FORMAT) {
//			setMessage(R.string.invalid_api_format).showAlertDialog();
//		} else if (errorCode == APIBase.ErrorCode.TOKEN_ERROR) {
//			setMessage(R.string.token_error).showAlertDialog();
//		} else if (errorCode == APIBase.ErrorCode.NETWORK_NOT_AVAILABLE) {
//			setMessage(R.string.network_not_available).showAlertDialog();
//		}
//	}
